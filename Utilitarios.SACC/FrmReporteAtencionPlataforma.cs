...
{
    public partial class FrmReporteAtencionPlataforma : Form
    {
        public FrmReporteAtencionPlataforma()
        {
            InitializeComponent();
        }

        private void FrmReporteAtencionPlataforma_Load(object sender, EventArgs e)
        {
